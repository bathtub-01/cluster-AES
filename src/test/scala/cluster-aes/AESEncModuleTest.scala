...
class AESEncModuleTest extends AnyFlatSpec with ChiselScalatestTester {
  val state = Array(0x32, 0x43, 0xf6, 0xa8, 0x88, 0x5a, 0x30, 0x8d, 
                    0x31, 0x31, 0x98, 0xa2, 0xe0, 0x37, 0x07, 0x34)
  "AESEnc" should "pass" in {
    test(new AESEncModule).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
